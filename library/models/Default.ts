...
export class Default {
    ...
    public setConfig(config:Config):Default {
        ...
        if (config.token !== undefined) { this.setToken(this.config.token); }
        return this;
    }
    ...
    public getToken(): string {
        return this.config.token ? this.config.token : '';
    }
    ...
    private async send(request:Request):Promise<Response|undefined> {
    ...
    public async _index(params?:any):Promise<Response|undefined>{
    ...
    public async _all():Promise<Response|undefined> { return this._index(); }

    public async _create(data:any, params?:any):Promise<Response|undefined> {
        const request:Request = {
    ...
    public async _read(key:string|number, params?:any):Promise<Response|undefined> { return await this._show(key, params); }
    ...
    public async _delete(key:string|number):Promise<Response|undefined> {
        const request:Request = {
    ...
    public async _get(key?:string|number, params?:any):Promise<Response|undefined> { return key ? await this._show(key, params) : await this._index(); }

    public async _patch(key:string|number, data:any, params?:any):Promise<Response|undefined> { return await this._update(key, data, params, RequestMethod.PATCH); }

    public async _post(data:any, params?:any):Promise<Response|undefined> { return await this._create(data, params); }

    public async _put(key:string|number, data:any, params?:any):Promise<Response|undefined> { return await this._update(key, data, params); }
...
export class Model extends Default {
    ...
    public async update(data:any, params?:any, method:RequestMethod = RequestMethod.PUT):Promise<Response|undefined> {
        if (!this.exists) { return EmptyResponse; }
        const request:Request = {
            method: method,
